...
const ButtonLink = forwardRef<HTMLAnchorElement, ButtonLinkProps>(
    ({ className, children, buttonType, ...props }, ref) => {
        ...
        switch (buttonType) {
            ...
            case 'primary':
                selectedStyle =
                    'rounded-md shadow-lg shadow-blue-500/50 hover:shadow-md dark:shadow-blue-500/25 text-white bg-blue-500 transition-colors hover:bg-blue-400 focus:outline-none focus:ring-2 dark:ring-offset-slate-900 focus:ring-offset-2 focus:ring-blue-500 relative active:top-0.5'
                break
            case 'pink':
                selectedStyle =
